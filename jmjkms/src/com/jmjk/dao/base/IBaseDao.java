...
public interface IBaseDao<T> {
	...
	public void saveList(List<T> list);//保存一个list
	 ...
	 * @return（档案编号）
	 */
	public String getFileNum(String sql);
	/**
	 * 获得员工编号
	 * @param sql
	 * @return（员工编号）
	 */
	public String getStaffNum(String sql);
	
	/**
	 *  hql带参数的获得多个T类型的对象，对name属性支持模糊查询
	 * @param hql
	 * @param params
	 * @return
	 */
	public List<T> find2(String hql, Map<String, Object> params);
