 ...
 *
 */
public interface IIncompleteRecordService2 {
	/**
	 * 添加接诊记录
	 ...
	 * @return
	 */
	public List<VIncompleteRecord2> getAllIncompleteRecordForSpecial(int staffId);
	/**
	 * 得到所有随诊记录（集团负责人），（用于导出）
	 * @param groupId集团id
	 * @return
	...
	public List<VIncompleteRecord2> getAllIncompleteRecord(Page<VIncompleteRecord2> page,int hosId);
	/**
	 * 得到接诊记录试图(平台管理员)
	 * @param page
	 * @return
	 */
	public List<VIncompleteRecord2> getAllIncompleteRecord(Page<VIncompleteRecord2> page);
	/**
	 * 得到接诊记录试图(集团)
	 * @param page
	 * @param groupId
	 ...
	 * @return
	 */
	public List<VIncompleteRecord2> getAllIncompleteRecordForSpecial(Page<VIncompleteRecord2> page,int staffId);
	/////////////////////////////////////////多条件查询///////////////////////////////////////
	/**
...
/**
	 ...
	 * @return
	 */
	public List<VIncompleteRecord2> findChronicPeople(SearchBeanSU se , Page<VIncompleteRecord2> page,int hosId);
/**
	 * 返回所有接诊记录视图(平台管理员多条件)
	 * @param se
	 * @param page
	 * @return
	 */
	public List<VIncompleteRecord2> findChronicPeople(SearchBeanSU se , Page<VIncompleteRecord2> page);
/**
	 ...
	 * @return
	 */
	public List<VIncompleteRecord2> findChronicPeopleForSpecial(SearchBeanSU se , Page<VIncompleteRecord2> page,int staffId);
