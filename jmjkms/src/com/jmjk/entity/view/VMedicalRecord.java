...
/**
 * VMedicalRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "V_MEDICAL_RECORD", catalog = "jmjk")
public class VMedicalRecord implements java.io.Serializable {
	...
	private String note;
	private String medicalRecordOne;
	private String medicalRecordTwo;
	private String medicalRecordThree;
	private String medicalRecordFour;
	private String medicalRecordFive;
	...
	/** default constructor */
	public VMedicalRecord() {
	}

	/** minimal constructor */
	public VMedicalRecord(Integer medicalRecordId, String name, String idNum,
	...
	/** full constructor */
	public VMedicalRecord(Integer medicalRecordId, String fileNum, String name,
			...
			Timestamp beginDate, Timestamp stopDate, String drugName,
			String usages, String dosage, String medicationAdherence,
			String note, String medicalRecordOne, String medicalRecordTwo,
			String medicalRecordThree, String medicalRecordFour,
			String medicalRecordFive, Integer oldStaffHosId,
		...
		this.note = note;
		this.medicalRecordOne = medicalRecordOne;
		this.medicalRecordTwo = medicalRecordTwo;
		this.medicalRecordThree = medicalRecordThree;
		this.medicalRecordFour = medicalRecordFour;
		this.medicalRecordFive = medicalRecordFive;
		this.oldStaffHosId = oldStaffHosId;
	...
	@Column(name = "MEDICAL_RECORD_ONE", length = 1000)
	public String getMedicalRecordOne() {
		return this.medicalRecordOne;
	}

	public void setMedicalRecordOne(String medicalRecordOne) {
		this.medicalRecordOne = medicalRecordOne;
	}

	@Column(name = "MEDICAL_RECORD_TWO", length = 1000)
	public String getMedicalRecordTwo() {
		return this.medicalRecordTwo;
	}

	public void setMedicalRecordTwo(String medicalRecordTwo) {
		this.medicalRecordTwo = medicalRecordTwo;
	}

	@Column(name = "MEDICAL_RECORD_THREE", length = 1000)
	public String getMedicalRecordThree() {
		return this.medicalRecordThree;
	}

	public void setMedicalRecordThree(String medicalRecordThree) {
		this.medicalRecordThree = medicalRecordThree;
	}

	@Column(name = "MEDICAL_RECORD_FOUR", length = 1000)
	public String getMedicalRecordFour() {
		return this.medicalRecordFour;
	}

	public void setMedicalRecordFour(String medicalRecordFour) {
		this.medicalRecordFour = medicalRecordFour;
	}

	@Column(name = "MEDICAL_RECORD_FIVE", length = 1000)
	public String getMedicalRecordFive() {
		return this.medicalRecordFive;
	}

	public void setMedicalRecordFive(String medicalRecordFive) {
		this.medicalRecordFive = medicalRecordFive;
	}
