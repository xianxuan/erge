...
//修改预警状态
	...
	@Override
	public String getAlarmBloodPressureDetail(int bpID) {
		// TODO Auto-generated method stub
		String url=WebXMLParameter.getParamValue("ip_port")+"/healthy/bloodPressure/getSingle";
		Map<String,String> params = new HashMap<String, String>();
		params.put("id", bpID+"");
		String resultJson = MyHttpClient.sendHttpPost(url, params);
		return resultJson;
	...
	@Override
	public String getAlarmBloodSugarDetail(int bsID) {
		// TODO Auto-generated method stub
		String url=WebXMLParameter.getParamValue("ip_port")+"/healthy/bloodSugar/getSingle";
		Map<String,String> params = new HashMap<String, String>();
		params.put("id", bsID+"");
		String resultJson = MyHttpClient.sendHttpPost(url, params);
		return resultJson;
