...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
     ...
     <input id='embeded' type='hidden' name='embeded' value='${embeded }'>
     ...
     <s:if test="sq==1"><!-- 0是平台管理员登陆，1是集团登陆，2是其他登陆 -->
       ...
       <select name="searchbean.selectFlag" >
         ...
         <option value="4" <c:if test="${'4' eq searchbean.selectFlag}">selected</c:if>>请选择</option>
       </select>
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn-xiugai"  href="healthFileAction!turnToHealthFileDetil.action?healthFileId=${healthFileId}&hosId=${communityHospital.communityHospitalId}&healthCloudId=${-id}">编辑</a>
                 ...
                 <a href="PhysicalExamAction!showPhysicalExamListBypersonal.action?healthFileId=${healthFileId}&belongSystem=${belongSystem}&jiGouFileNum=${fileNum}&jiGouname=${name}&jiGousex=${sex}&embeded=${embeded}"  class="btn-xianshi">查看体检</a>
