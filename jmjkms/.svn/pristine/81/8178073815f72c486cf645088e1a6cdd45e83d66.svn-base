  ...
  <input name="yemianname" value="01202" type="hidden"/>
    ...
    <div class="container">
     <h3 class="current-title">慢性病随访记录</h3>
      ...
      <form action="<%=basePath %>oldChronicFollowAction!addDiabets.action?cid=${chronicDisease.chronicDiseaseId}&hid=${healthFile.healthFileId}" onsubmit="return dosubmit()" method="post" id="registerform">
      <div class="table-content">
        <table class="table table-bordered">
          <tbody>
           ...
           <tr>
             <td><input type="hidden" name="token" value="${token}" /><span class="required">*</span>随访日期</td>
           ...
           <tr>
             ...
             <td > 主食(g/天)</td>
             <td colspan="2" ><input onkeyup="Num(this)" type="text" class="w40" name="lifestyleGuide.stapleFood" maxlength="10"></td>
            </tr>
             <tr>
               <td>运动</td>
            ...
            <tr>
            <td >空腹血糖（mmol/l）</td>
            <td colspan="2"><input onkeyup="Num(this)" type="text" name="diabetsFollow.fastingBloodGlucose"  maxlength="10" ></td>
            <td>糖化血红蛋白（%）</td>
            <td><input onkeyup="Num(this)" type="text" name="diabetsFollow.glycosylatedHemoglobin"  maxlength="10" ></td>
            <td >检查日期</td><td colspan="2">
              <input type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" onfocus="this.blur()" name="diabetsFollow.inspectionDate">
            </td>
            </tr>
            <tr>
            	<td>其他检查</td><td colspan="3"><input class="temp"  type="text" name="diabetsFollow.otherInspection" maxlength="80"></td>
          ...
          <tr>
            ...
            <div class="jia">
               ...
               <input type="text" id="gai" class="gai"   name="diabetsFollow.insulin" placeholder="请选择">
            </div>
            </td>
          </tr>
           <tr>
               ...
               <input type="text" id="gai" class="gai"   name="diabetsFollow.transfer" placeholder="请选择">
               </div>
               </td>
                <td>下次随访日期</td>
                <td colspan="3">
                  <input type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" onfocus="this.blur()" name="diabetsFollow.nextFollow">
               </td>
               </tr>
                 <tr rowspan="2">
                <td>备注</td>
                <td colspan="7"><textarea    id=""  class="textarea temp" name="diabetsFollow.note"></textarea></td>
                </tr>
          </tbody>
        </table>
        <div class="btn-content">
