...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
       ...
       <div class="search-content">
         <input name="yemianname" value="02205" type="hidden"/>
          <div class="btn-content">
            <a href="chronicManagerAction!getBloodSugerFromCloud.action?bloodForward=0&healthFileId=${healthFile.healthFileId }" class="btn">数据分析</a>
       ...
       <form id="registerform" action="chronicManagerAction!bloodSugerDataAnalysis.action" method="post">
