...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
       <h3 class="current-title">住院记录</h3>
      
      <!-- 删除此行注释，在此添加对应的div -->
     <div class="search-content">
     <input name="yemianname" value="06207" type="hidden"/>
      <form id="entity" action="inHospitalHistoryAction!searchInHospitalHistory.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="inHospitalHistoryAction!findAndAddInHospitalHistory.action" class="btn">添加</a>
     </div>
 	</form>
  ...
  <div class="table-content">
   <form action="inHospitalHistoryAction!fuction.action" method="post">
   <table class="table table-bordered">
     <tbody>
      ...
      <%--  <s:action name="inHospitalHistoryAction!showInHospitalHistory.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vinHospitalHistoryList" status="n">
        <input type="hidden" name="choice" value="${inHospitalHistoryId}">
       <tr>
        <%--  <td><input class="zyq" type="checkbox" name="allInHospitalHistoryId" id="ck_id" value="${inHospitalHistoryId}"></td> --%>
         ...
         <td>${inDate}</td>
         <td>${outDate}</td>
         <td colspan="3"><a  class="btn-xinzeng" href="inHospitalHistoryAction!turnToAddPersonInHospitalHistory.action?healthFileId=${healthFileId}">新增</a>
         <a  class="btn-xianshi" href="inHospitalHistoryAction!turnToDetailInHospitalHistory.action?healthFileId=${healthFileId}&ihhId=${inHospitalHistoryId}">详情</a>
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="inHospitalHistoryAction!deleteInHospitalHistory.action?ihhId=${inHospitalHistoryId}">删除</a>
         <a class="btn-xiugai" href="inHospitalHistoryAction!turnToUpdateInHospitalHistory.action?ihhId=${inHospitalHistoryId}&healthFileId=${healthFileId}">修改</a></td>
       </tr>
        </s:iterator>
