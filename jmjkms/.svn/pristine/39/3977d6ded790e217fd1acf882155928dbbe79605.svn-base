       ...
       <!-- 血氧表单表格 start -->
         <form id="registerform" action="HealthManagerAction!editBOCloud.action"  method="post" id="bloodoxygen">
           <table class="table table-bordered">
             <tbody>
               <tr>
                 <td><span style="color:red">*</span>测量条件 <input  type="hidden" name="healthFileId" value="${healthFile.healthFileId}"/>
                ...
                <td>
                 ...
                 <td><input type="text"   name="bloodOxygen.oxygen"   datatype="*" nullmsg="血氧值不可为空" value="${bloodOxygen.oxygen }"></td>
               
               </tr>
                  <tr>
                   <td><span style="color:red">*</span>脉搏率(次/min)</td>
                <td><input type="text"  name="bloodOxygen.pulse" value="${bloodOxygen.pulse }" maxlength='10'  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" datatype="*" nullmsg="脉率不可为空" ></td>
                 ...
                 <td colspan="3"><select name="bloodOxygen.abnAlarm"  id="">
                  ...
                  <td colspan="7">
					...
					class="textarea" datatype="*" nullmsg="血氧分析结果不可为空">${bloodOxygen.analysisResult}</textarea>
				 </td>
                 </tr>
             </tbody>
           </table>
