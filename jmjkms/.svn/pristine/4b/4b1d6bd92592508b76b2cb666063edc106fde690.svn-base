	...
	Ext.onReady(function(){
		var tabs = new Ext.TabPanel({
			...
			items:[
				...
				{contentEl:'xyda', title: '血压档案'},
				{contentEl:'xtda', title: '血糖档案'},
				{contentEl:'jkytjda', title: '健康一体机档案'},
				{contentEl:'ncgda', title: '尿常规档案'},
				{contentEl:'xdda', title: '心电档案'},
				{contentEl:'tjxx', title: '体检信息'},
				{contentEl:'jiezhen', title: '接诊记录'},
			],
		...
		<div class="container">
           ...
           -->
				...
				<div id="jiezhen" class="x-hide-display" style="margin:3px;">
					<%@ include file="alterJzjlPart.jsp" %>
				</div>
				<!-- 接诊记录 End -->
