...
/**
 * VInHospitalHistory entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "V_IN_HOSPITAL_HISTORY", catalog = "jmjk")
public class VInHospitalHistory implements java.io.Serializable {
	...
	private String note;
	private String inHospitalHistoryOne;
	private String inHospitalHistoryTwo;
	private String inHospitalHistoryThree;
	private String inHospitalHistoryFour;
	private String inHospitalHistoryFive;
	...
	/** default constructor */
	public VInHospitalHistory() {
	}

	/** minimal constructor */
	public VInHospitalHistory(Integer inHospitalHistoryId,
			Integer healthFileId, String name, String idNum, String IPhone,
	...
	/** full constructor */
	public VInHospitalHistory(Integer inHospitalHistoryId,
			Integer healthFileId, Timestamp inDate, Timestamp outDate,
			String reason, String institution, String medicalRecord,
			String note, String inHospitalHistoryOne,
			String inHospitalHistoryTwo, String inHospitalHistoryThree,
			String inHospitalHistoryFour, String inHospitalHistoryFive,
		...
		this.note = note;
		this.inHospitalHistoryOne = inHospitalHistoryOne;
		this.inHospitalHistoryTwo = inHospitalHistoryTwo;
		this.inHospitalHistoryThree = inHospitalHistoryThree;
		this.inHospitalHistoryFour = inHospitalHistoryFour;
		this.inHospitalHistoryFive = inHospitalHistoryFive;
	...
	// Property accessors
	@Id
	@Column(name = "IN_HOSPITAL_HISTORY_ID", nullable = false)
	...
	@Column(name = "IN_HOSPITAL_HISTORY_ONE", length = 1000)
	public String getInHospitalHistoryOne() {
		return this.inHospitalHistoryOne;
	}

	public void setInHospitalHistoryOne(String inHospitalHistoryOne) {
		this.inHospitalHistoryOne = inHospitalHistoryOne;
	}

	@Column(name = "IN_HOSPITAL_HISTORY_TWO", length = 1000)
	public String getInHospitalHistoryTwo() {
		return this.inHospitalHistoryTwo;
	}

	public void setInHospitalHistoryTwo(String inHospitalHistoryTwo) {
		this.inHospitalHistoryTwo = inHospitalHistoryTwo;
	}

	@Column(name = "IN_HOSPITAL_HISTORY_THREE", length = 1000)
	public String getInHospitalHistoryThree() {
		return this.inHospitalHistoryThree;
	}

	public void setInHospitalHistoryThree(String inHospitalHistoryThree) {
		this.inHospitalHistoryThree = inHospitalHistoryThree;
	}

	@Column(name = "IN_HOSPITAL_HISTORY_FOUR", length = 1000)
	public String getInHospitalHistoryFour() {
		return this.inHospitalHistoryFour;
	}

	public void setInHospitalHistoryFour(String inHospitalHistoryFour) {
		this.inHospitalHistoryFour = inHospitalHistoryFour;
	}

	@Column(name = "IN_HOSPITAL_HISTORY_FIVE", length = 1000)
	public String getInHospitalHistoryFive() {
		return this.inHospitalHistoryFive;
	}

	public void setInHospitalHistoryFive(String inHospitalHistoryFive) {
		this.inHospitalHistoryFive = inHospitalHistoryFive;
	}
