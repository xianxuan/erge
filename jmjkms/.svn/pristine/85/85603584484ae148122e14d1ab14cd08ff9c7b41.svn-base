  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
     ...
     <div class="search-content">
       <form id="entity" action="incompleteRecordAction!searchIncompleteRecord.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="incompleteRecordAction!findAndAddIncompleteRecord.action" class="btn">添加</a>
     </div>
 	</form>
     </div>
  ...
  <form action="incompleteRecordAction!fuction.action" method="post">
   <table class="table table-bordered">
     ...
     <%--   <s:action name="incompleteRecordAction!showIncompleteRecord.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vincompleteRecordList" status="n">
       ...
       <tr>
        <%--  <td><input class="zyq" type="checkbox" name="allIncompleteRecordId" id="ck_id" value="${incompleteRecordId}"></td> --%>
         ...
         <td><c:out value="${incompleteRecordDate}"></c:out></td>
         <td colspan="3"><a class="btn-xinzeng" href="incompleteRecordAction!turnToAddPersonIncompleteRecord.action?healthFileId=${healthFileId}">新增</a>
         <a class="btn-xianshi" href="incompleteRecordAction!turnToDetailIncompleteRecord.action?healthFileId=${healthFileId}&irId=${incompleteRecordId}">详情</a>
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="incompleteRecordAction!deleteIncompleteRecord.action?irId=${incompleteRecordId}">删除</a>
         <a class="btn-xiugai" href="incompleteRecordAction!turnToUpdateIncompleteRecord.action?irId=${incompleteRecordId}&healthFileId=${healthFileId}">修改</a></td>
       </tr>
       </s:iterator>
     </tbody>
   </table>
