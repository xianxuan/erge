        ...
        <table id="jqprint" class="table table-bordered" style="word-break:break-all">
          ...
          <tr>
           ...
           <tr>  
             ...
             <td>确诊日期</td>
             <td><label><fmt:formatDate value="${vchronic.tumourDiagnosisDate}" pattern="yyyy-MM-dd" /></label></td>
           </tr>
           <tr>
             <td>确诊医院</td>
             <td>
           ...
           <tr>
              ...
              <td>第三次</td>
              <td><label><fmt:formatDate value="${vchronic.thirdTime}" pattern="yyyy-MM-dd" /></label></td>
           </tr>
            <tr>
             <td>肿瘤家族史</td>
