           ...
           <table class="table table-bordered">
             <tbody>
               <tr>
                 ...
                 <td>药物名称</td>
                 <td>
                   <input type="text" class="temp" name="bloodSuger.medName"   value="${medName}"/>
                 </td>
                  <td><span style="color:red">*</span>血糖值(mmoL/L )</td>
                 <td><input type="text" class="temp" name="bloodSuger.bloodSugar"  onkeyup="Num(this)" maxlength='4' datatype="*" nullmsg="血糖值不可为空" value="${bloodSugar }"></td>
                </tr>
                <tr>
               ...
               <tr>
                  ...
                  <textarea name="bloodSuger.analysisResult" id=""  
					class="textarea temp" datatype="*" nullmsg="血糖分析结果不可为空">${analysisResult}</textarea>
				 </td>
                </tr>
             </tbody>
           </table>
