...
/**
 * VConsultationRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "V_CONSULTATION_RECORD", catalog = "jmjk")
public class VConsultationRecord implements java.io.Serializable {
	...
	private String consultationRecordOne;
	private String consultationRecordTwo;
	private String consultationRecordThree;
	private String consultationRecordFour;
	private String consultationRecordFive;
	...
	/** default constructor */
	public VConsultationRecord() {
	}

	/** minimal constructor */
	public VConsultationRecord(Integer consultationRecordId, String name,
	...
	/** full constructor */
	public VConsultationRecord(Integer consultationRecordId, String fileNum,
			...
			Timestamp conRecDate, String consultationRecordOne,
			String consultationRecordTwo, String consultationRecordThree,
			String consultationRecordFour, String consultationRecordFive,
		...
		this.consultationRecordOne = consultationRecordOne;
		this.consultationRecordTwo = consultationRecordTwo;
		this.consultationRecordThree = consultationRecordThree;
		this.consultationRecordFour = consultationRecordFour;
		this.consultationRecordFive = consultationRecordFive;
		this.oldStaffHosId = oldStaffHosId;
	...
	@Column(name = "CONSULTATION_RECORD_ONE", length = 1000)
	public String getConsultationRecordOne() {
		return this.consultationRecordOne;
	}

	public void setConsultationRecordOne(String consultationRecordOne) {
		this.consultationRecordOne = consultationRecordOne;
	}

	@Column(name = "CONSULTATION_RECORD_TWO", length = 1000)
	public String getConsultationRecordTwo() {
		return this.consultationRecordTwo;
	}

	public void setConsultationRecordTwo(String consultationRecordTwo) {
		this.consultationRecordTwo = consultationRecordTwo;
	}

	@Column(name = "CONSULTATION_RECORD_THREE", length = 1000)
	public String getConsultationRecordThree() {
		return this.consultationRecordThree;
	}

	public void setConsultationRecordThree(String consultationRecordThree) {
		this.consultationRecordThree = consultationRecordThree;
	}

	@Column(name = "CONSULTATION_RECORD_FOUR", length = 1000)
	public String getConsultationRecordFour() {
		return this.consultationRecordFour;
	}

	public void setConsultationRecordFour(String consultationRecordFour) {
		this.consultationRecordFour = consultationRecordFour;
	}

	@Column(name = "CONSULTATION_RECORD_FIVE", length = 1000)
	public String getConsultationRecordFive() {
		return this.consultationRecordFive;
	}

	public void setConsultationRecordFive(String consultationRecordFive) {
		this.consultationRecordFive = consultationRecordFive;
	}
