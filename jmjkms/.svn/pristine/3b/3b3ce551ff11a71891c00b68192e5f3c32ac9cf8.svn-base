...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">健康一体机-趋势分析</h3>
      <input name="yemianname" value="02202" type="hidden"/>
       <div class="search-content">
          <div class="btn-content">
            <a href="HealthManagerAction!getAllInOneFromCloud.action?bloodForward=0&healthFileId=${healthFile.id }" class="btn btn-default">数据分析</a>
            <a href="HealthManagerAction!getAllInOneFromCloud.action?bloodForward=1&healthFileId=${healthFile.id }" class="btn">趋势分析</a>
...
function myHighchars(){
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: '${healthFile.name}的一体机数据趋势图'
        },
        xAxis: {
              categories: ${xAxis},
        },
