...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
     ...
     <form id="entity" action="healthFileAction!searchMore.action">
     <input id="cp" type="hidden" name="cp1" value="${cp}">
     <div class="search-item">
    <s:if test="is==0"><!-- 0是平台管理员登陆，1是集团登陆，2是其他登陆 -->
        <label>社区集团：</label>
     ...
     <s:if test="is==1"><!-- 0是平台管理员登陆，1是集团登陆，2是其他登陆 -->
       <label>社区医院：</label>
       	<select name="searchbean.sqid">
       		<option value="">全部</option>
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <!-- <input type="button" value=" " class="btn-xinzeng btn"  onclick="clickon_01()"  id="btn_alert_01"> -->
     </div>
 	</form>
    ...
    <form id="form_alert_01" style="display:none;" action="<%=basePath %>healthFileAction!input.action" method="post"  enctype="multipart/form-data" >
   	<input  class="tan-btn btn" type="file" name="upload" />
           ...
           <input type="hidden" name="choice1" value="${healthFileId}"/>
            <tr>
             ...
             <%--  <td><input class="zyq qq" type="checkbox" name="allHealthFileId" id="ck_id" value="${healthFileId}"></td> --%>
              ...
              <td>
                <a class="btn-xianshi"  href="healthFileAction!turnToHealthFileView.action?healthFileId=${healthFileId}">详情</a>
                <div id="mask_alert" class="mask_alert">
				</div>
				<div id="demo_alert" class="demo_alert">
					<div id="fa" class="btn-close">
					...
					<div id="button_alert">
						...
						<a href="healthFileAction!cancelHealthFile.action?healthFileId=${healthFileId}"  class="btn btn_white btn-shanchu" id="btn_write_off">注销</a>
					 	<a  href="healthFileAction!deleteHealthFile.action?healthFileId=${healthFileId}" class="btn btn_white btn-shanchu" id="btn_delete">删除</a>
						<a href="healthFileAction!killHealthFile.action?healthFileId=${healthFileId}"   class="btn btn_white btn-shanchu" id="btn_regist" >死亡登记</a>
					</div>
				</div>
              </td>
            </tr>
