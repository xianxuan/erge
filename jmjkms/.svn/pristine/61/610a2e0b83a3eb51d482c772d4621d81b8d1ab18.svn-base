...
<body>
	...
	<div class="main-content clearfix">
		...
		<input name="yemianname" value="10202" type="hidden"/>
			<h3 class="current-title">修改专家康复方案</h3>
			<!-- 搜索容器 start -->
			<form id="registerform" action="<%=basePath%>healthPhysiotherapyAction!editExpertRecoveryScheme.action"
				...
				<div class="table-content">
						...
						<td><input type="hidden" class="w150"
							...
							<tr>
								...
								<td><input type="hidden" class="w150"
									...
									value="${trecoveryScheme.type }"><label>专家方案</label></td>
							</tr>
							<tr>
								<td>方案名称</td>
								<td colspan="2"><input type="text" class="w150"
									name="trecoveryScheme.schemeName"
									value="${trecoveryScheme.schemeName }"datatype="*" nullmsg="不可为空" errormsg="输入有误"></td>
							</tr>
							<tr>
								...
								<td><select name="trecoveryScheme.disease" id="disease">
											...
											<option value="重要精神疾病" >重要精神疾病</option>
							...
							<tr>
								...
								<td><input type="text"
									...
									name="trecoveryScheme.constituteTime" value="${trecoveryScheme.constituteTime }"
									onfocus="this.blur()" 
					...
					<div class="btn-content">
						...
						<a href="<%=basePath %>healthPhysiotherapyAction!getExpertScheme.action" class="btn">取消</a>
					</div>
				</div>
			</form>
			<!-- 表格容器 end -->
