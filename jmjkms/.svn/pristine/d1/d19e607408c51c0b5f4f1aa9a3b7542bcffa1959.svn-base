    ...
    <div class="container">
       ...
       <div class="search-content">
          <div class="btn-content">
            <a href="HealthManagerAction!getBloodSugerFromCloud.action?bloodForward=0&healthFileId=${localHealthFile.healthFileId }&embeded=${embeded}" class="btn btn-default">数据分析</a>
            <a href="HealthManagerAction!getBloodSugerFromCloud.action?bloodForward=1&healthFileId=${localHealthFile.healthFileId }&embeded=${embeded} " class="btn btn-default">趋势分析</a>
            <a href="HealthManagerAction!getBloodSugerFromCloud.action?bloodForward=2&healthFileId=${localHealthFile.healthFileId }&embeded=${embeded}" class="btn ">详细数据</a>
    ...
    <table class="table table-bordered">
         ...
         <s:iterator value="bloodSugerList" var="bsl">
           <tr>
             ...
             <td class="caozuo">
              <a class="btn-xiugai" href="HealthManagerAction!toEditBSCloud.action?healthFileId=${healthFileId }&cloudId=${bsl.id}&bloodSugar=${ bsl.bloodSugar}&meaState=${bsl.meaState }&takeMed=${bsl.takeMed }&medName=${bsl.medName }&abnAlarm=${bsl.abnAlarm }&meaTime=${bsl.meaTime}&analysisResult=${bsl.analysisResult}&embeded=${embeded}">修改</a>
               <a class="btn-shanchu" href="HealthManagerAction!deleteBloodSugerDataCloud.action?healthFileId=${healthFileId }&cloudId=${bsl.id}&embeded=${embeded}" onclick="return confirm('确认删除')">删除</a>
            </td>
           </tr>
         </s:iterator>
         </tbody>
