...
<body>
	...
	<div class="main-content clearfix">
		...
		<!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">尿常规检测记录</h3>
 <!-- 搜索容器 start -->
			 <div class="search-content">
			  <input name="yemianname" value="02202" type="hidden"/>
			  
			    <form action="UrineAction!getListByCX.action" method="post">
   ...
   <table class="table table-bordered">
     ...
     <tbody>
     <s:iterator value="theItems" var="urine">
       <tr>
         <td>${name}</td>
         <td>${urine.idCard}</td>
         <td>${urine.bld}</td>
         ...
         <td>${urine.meaTime}</td>
          <td>
           <a class="btn-xianshi" href="UrineAction!showDetail.action?id=${urine.id}&healthFileId=${healthFileId}">查看详情</a>
          </td>
   ...
   <div class="page">
	...
	<div class="btn-content">
      <a class="btn btn-xianshi"  href="HealthDailyCheckAction!getHealthFileList.action" style="display:inline;">返回</a>
    </div>
 </div>
 <!-- 表格容器 end -->      
</div>
