...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
    <h3 class="current-title">高血压医生诊断添加</h3>
 <!-- 表单表格 start -->
                 
    <div class="table-content">
      	<input name="yemianname" value="02204" type="hidden"/>
          <form id="registerform" action="doctorDiagnosisAction!addDoctorDiagnosisAction.action" method="post" onsubmit="return dosubmit()">
                         ...
                         <tr>
                           ...
                           <tr>                                      <td>建议</td>
                            ...
                            <tr>
                                      ...
                                      <td colspan="6"><input type="text" value="${currentTime }" name="doctorDiagnosis.date" class="w150" id="time" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"></td>
                           </tr>
                       </tbody>
               </table>
