...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
        <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">高血压健康管理</h3>
			 ...
			 <option value="">请选择</option>
         	 <s:iterator value="staffs" var="s">
			     ...
			     <div class="search-item">
			      ...
			      <input name="searchbean.renqun" value="1" type="hidden"/>
			      <input name="flagsear" value="flagBlood" type="hidden"/>	  	
			      <div class="search-item">
      				 <label>档案状态：</label>
			   ...
			   <a href="chronicManagerAction!addHighManager.action" class="btn btn-xinzeng" >添加老人</a>
			     </div>
			 	</form>
			 </div>
 	<form action="<%=basePath%>chronicManagerAction!function.action"  method="post">
        ...
        <table class="table table-bordered">
          ...
          <input type="hidden" name="ids" id="id" value="${vc.chronicDiseaseId}">
            <tr>
              ...
              <td>${vc.name}</td>
              <td> <a class="btn-xianshi" href="chronicManagerAction!getBloodPressFromCloud.action?healthFileId=${vc.healthFileId }">详情</a></td>
              <!-- 还需传一个档案ID -->
              ...
              <td>
                ...
                <a class="btn-shanchu" href="chronicManagerAction!deleteHighManager.action?daId=${vc.healthFileId }&chronicName=${vc.diseaseName}" onclick="return confirm('是否删除？')">删除</a>
              </td>
            </tr>
            </s:iterator>
