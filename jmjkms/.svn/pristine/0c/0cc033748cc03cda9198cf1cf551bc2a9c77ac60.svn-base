    ...
    <div class="container">
      <h3 class="current-title">接诊记录-新增</h3>
        ...
        <div class="search-content">
          <form action="incompleteRecordAction!findIncompleteRecord.action" method="post" id="registerform1">
            <label>查询选项：</label>
              <select name="flag" id="">
        ...
        <div class="table-content">
           ...
           <form id="registerform" action="incompleteRecordAction!addIncompleteRecord.action" method="post" onsubmit="return dosubmit()">
             ...
             <tbody>
               ...
               <input type="hidden" name="token" value="${token }" />
                <input type="hidden" name="healthFileId" value="${ healthFile.healthFileId}" /> 
                 ...
                 <td colspan="3"><input type="text" id="Date" onfocus="this.blur()"  name="incompleteRecord.incompleteRecordDate" value="${currentTime}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" ></td>
                 <td><span class="required">*</span>接诊医生</td>
                  <td> <select name="incompleteRecord.incompleteDoctor" class="js-example-basic-single" class="select2" style="width: 170px;" id="Doctor" datatype="*" nullmsg="接诊医生不可为空"  maxlength="5">
               ...
               <tr >
               <td>就诊者的主观资料</td>
                 <td colspan="7"><textarea name="incompleteRecord.subInfor"   id=""  class="textarea"></textarea></td>
               </tr>
               <tr>
               <td>就诊者的客观资料</td>
               <td colspan="7"><textarea name="incompleteRecord.objInfor"   id=""  class="textarea"></textarea></td>
               </tr>
               <tr>
               <td>评估</td>
               <td colspan="7"><textarea name="incompleteRecord.assess"   id=""  class="textarea"></textarea></td>
               </tr>
               <tr>
                 <td >处置计划</td>
                 <td colspan="7"><textarea name="incompleteRecord.disposalPlan"   id=""  class="textarea"></textarea></td>
               </tr>
             </tbody>
            </table>
           ...
           <div class="btn-content">
            ...
            <input id="submit" type="submit" value="提交" class="btn">
             ...
             <a href="incompleteRecordAction!showIncompleteRecord.action" class="btn ">返回</a>
           </div>
           </form>
          </div>
