...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
      ...
      <h3 class="current-title">添加至糖尿病管理</h3>
      <input name="yemianname" value="02205" type="hidden"/>
       <div class="table-content">
        <form action="chronicManagerAction!addDiabeteConfirm.action" method="post">
        <table class="table table-bordered">
          ...
          <tbody>
          <s:iterator value="vcnodiabeteList" var="noadd">
            <tr>
