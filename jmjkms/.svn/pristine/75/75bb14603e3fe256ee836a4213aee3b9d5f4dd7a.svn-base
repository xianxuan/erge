...
public class HealthFileCloud {
	...
	public String toString() {
		return "HealthFileCloud [code=" + code + ", message=" + message
				+ ", page=" + page + "]";
	}

	public HealthFileCloud() {
		super();
		// TODO Auto-generated constructor stub
	}

	public HealthFileCloud(int code, String message, Page page) {
		super();
		this.code = code;
	...
	public class Page {
		...
		public int pageSize;
		public int pages;
		public ArrayList<HealthFile> result;
		public int startRow;
		public int total;
		...
		public Page(int endRow, int pageNum, int pageSize, int pages,
				ArrayList<HealthFile> result, int startRow, int total) {
			super();
			this.endRow = endRow;
		...
		public ArrayList<HealthFile> getResult() {
			return result;
		}

		public void setResult(ArrayList<HealthFile> result) {
			this.result = result;
		}
