...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
       ...
       <h3 class="current-title">家庭病床记录</h3>
      
      <!-- 删除此行注释，在此添加对应的div -->
     <div class="search-content">
     <input name="yemianname" value="06206" type="hidden"/>
      <form id="entity" action="familyBedHistoryAction!searchFamilyBedHistory.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="familyBedHistoryAction!findAndAddFamilyBedHistory.action" class="btn">添加</a>
     </div>
 	</form>
  ...
  <div class="table-content">
    <form action="familyBedHistoryAction!fuction.action" method="post">
   ...
   <table class="table table-bordered">
     <tbody>
       <tr>
        ...
        <%-- <s:action name="familyBedHistoryAction!showFamilyBedHistory.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vfamilyBedHistoryList" status="n">
        <input  type="hidden" name="choice"  id="id"  value="${familyBedHistoryId}"   />
       <tr>
        <%--  <td><input class="zyq" type="checkbox" name="allFamilyBedHistoryId" id="ck_id" value="${familyBedHistoryId}"></td> --%>
         ...
         <td><c:out value="${buildBedDate}"></c:out></td>
         <td colspan="3">
         	<a class="btn-xinzeng" href="familyBedHistoryAction!turnToAddPersonFamilyBedHistory.action?healthFileId=${healthFileId}">新增</a>
         	<a class="btn-xianshi" href="familyBedHistoryAction!turnToDetailFamilyBedHistory.action?healthFileId=${healthFileId}&fbhId=${familyBedHistoryId}">详情</a>
         	<a onclick="return confirm('是否删除？');" class="btn-shanchu" href="familyBedHistoryAction!deleteFamilyBedHistory.action?fbhId=${familyBedHistoryId}">删除</a>
         	<a class="btn-xiugai" href="familyBedHistoryAction!turnToUpdateFamilyBedHistory.action?fbhId=${familyBedHistoryId}&healthFileId=${healthFileId}">修改</a>
         </td>         
       </tr>
       </s:iterator>
