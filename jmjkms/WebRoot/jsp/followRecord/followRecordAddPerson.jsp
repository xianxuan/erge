           ...
           <table class="table table-bordered">
             ...
             <tbody>
               ...
               <input type="hidden" name="token" value="${token }" />
                ...
                <!--  <td>  <input type="text" name="followRecord.followDoctor"datatype="*" nullmsg="不可为空" errormsg="输入有误"> </td> -->
                 ...
                 <td><input type="text"  id="Date" onfocus="this.blur()"  name="followRecord.time" value="${currentTime}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"></td>
                 <td>体重</td>
                 ...
                 <td>呼吸</td>
                 <td>
                   <input name="followRecord.breathing"  maxlength="4" type="text"   onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  nullmsg="呼吸不可为空" errormsg="输入有误">次/分
                 </td>
               </tr>
               <tr>
                 <td>舒张压</td>
                 ...
                 <td>脉搏</td>
                 <td><input type="text"   maxlength="4" name="followRecord.pulse"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  nullmsg="不可为空" errormsg="输入有误">次/分</td>
