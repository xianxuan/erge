   ...
   <table class="table table-bordered">
     <thead>
       ...
       <tr>
         ...
         <td colspan="3"><a  class="btn-xinzeng" href="followRecordAction!turnToAddPersonFollowRecord.action?healthFileId=${healthFileId}">新增</a>
         ...
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="followRecordAction!deleteFollowRecord.action?followId=${followRecordId}">删除</a>
         <a class="btn-xiugai" href="followRecordAction!turnToUpdateFollowRecord.action?followId=${followRecordId}&healthFileId=${healthFileId}">修改</a></td>
       </tr>
       </s:iterator>
