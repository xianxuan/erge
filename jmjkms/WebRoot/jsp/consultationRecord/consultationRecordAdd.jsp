    ...
    <div class="container">
       ...
       <h3 class="current-title">会诊记录-新增</h3>
        ...
        <div class="search-content">
              <form id="registerform1" action="consultationRecordAction!findConsultationRecord.action" method="post" >
            <label>查询选项：</label>
              <select name="flag" id="">
  ...
  <div class="table-content">
            ...
            <table class="table table-bordered">
              <tbody>
                 ...
                 <td ><input type="text" onfocus="this.blur()"  id="Date" name="consultationRecord.conRecDate" value="${currentTime}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"></td>
               </tr>
               <tr >
                 <td>会诊医生及其所在医疗机构</td>
               ...
               <tr>
                 ...
                 <div class="btn-content">
                  <input type="submit" class="btn " value="提交" id="submit">
                   <a href="consultationRecordAction!showConsultationRecord.action" class="btn ">返回</a>
                 </div>
             </form>
        </div>
        </c:if>
        <div id="showwindow" class="table-content"" id="button_alert_2">
			...
			<tbody>
				<s:iterator value="listolder" var="lo">
					<tr>
					<td><a href="<%=basePath %>consultationRecordAction!ReOlder.action?healthFileId=${lo.healthFileId}" id="btn_write_off">${lo.name}</a></td>
					<td>${lo.idNum}</td>
				</s:iterator>
			</tbody>
			</table>
