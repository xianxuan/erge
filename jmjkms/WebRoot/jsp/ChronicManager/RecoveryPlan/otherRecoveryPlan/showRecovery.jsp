...
<body>
  ...
  <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">其他慢病康复计划</h3>
      ...
      <input name="yemianname" value="02206" type="hidden"/>
        <form id="registerform" action="chronicManagerAction!searchRecoveryPlan.action" method="post">
 		...
 		<div class="search-item">
          ...
          <div class="search-item">
           <label>计划名称：</label>
            <input id="planName" type="text" name="planName"    errormsg="不能输入特殊字符！" class="w150" > 
          </div>
          <div class="search-item">
            <label>计划状态：</label>
...
<h3 class="current-title">查询结果</h3>
 <div class="table-content">
   ...
   <div class="btn-content">
   	 <a class="btn btn-xianshi" href="chronicManagerAction!getAllOtherManager.action">返回</a>
   </div>
 </div>
 <!-- 表格容器 end -->
