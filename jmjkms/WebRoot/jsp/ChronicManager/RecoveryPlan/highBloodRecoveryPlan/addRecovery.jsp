...
<body>
	...
	<input name="yemianname" value="02204" type="hidden"/>
		...
		<!-- 主容器 start -->
		<div class="container">
			<h3 class="current-title">高血压康复计划添加</h3>
			...
			<form id="registerform" action="<%=basePath%>chronicManagerAction!addPlan.action"
				...
				<input class="temp" type="hidden" name="token" value="${token }" />
				<input class="temp" id="current" type="hidden" value="${currentTime }">
				...
				<div class="table-content">
					<table class="table table-bordered">
						...
						<tr>
							...
							<tr>
								...
								<td><select name="scheme" id="scheme" datatype="*" nullmsg="请添加方案">
								   </select></td>
							</tr>
							<tr>
					...
					<div class="btn-content">
						<input type="submit"  class="btn"  id="submit"  value="确定">
