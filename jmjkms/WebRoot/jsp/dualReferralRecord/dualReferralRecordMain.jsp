...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">双向转诊记录</h3>
      
      <!-- 删除此行注释，在此添加对应的div -->
     <div class="search-content">
     <input name="yemianname" value="06204" type="hidden"/>
      <form id="entity" action="dualReferralRecordAction!searchDualReferralRecord.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="dualReferralRecordAction!findAndAddDualReferralRecord.action" class="btn">添加</a>
     </div>
 	</form>
  ...
  <div class="table-content">
    <form action="dualReferralRecordAction!fuction.action" method="post">
   <table class="table table-bordered">
     <tbody>
      ...
      <%--  <s:action name="dualReferralRecordAction!showDualReferralRecord.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vdualReferralRecordList" status="n">
       <input  type="hidden" name="choice"  id="id"  value="${dualRefRecId}"   />
       <tr>
        <%--  <td><input type="checkbox" name="allDualReferralRecordId" id="ck_id" value="${dualRefRecId}"></td> --%>
         ...
         <td><c:out value="${outTime}"></c:out></td>
         <td colspan="3"><a class="btn-xinzeng" href="dualReferralRecordAction!turnToAddPersonDualReferralRecord.action?healthFileId=${healthFileId}">新增</a>
         <a class="btn-xianshi" href="dualReferralRecordAction!turnToDetailDualReferralRecord.action?healthFileId=${healthFileId}&drrId=${dualRefRecId}">详情</a>
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="dualReferralRecordAction!deleteDualReferralRecord.action?drrId=${dualRefRecId}">删除</a>
         <a class="btn-xiugai" href="dualReferralRecordAction!turnToUpdateDualReferralRecord.action?drrId=${dualRefRecId}&healthFileId=${healthFileId}">修改</a></td>
