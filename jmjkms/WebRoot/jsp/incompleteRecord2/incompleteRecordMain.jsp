...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
           ...
           <h3 class="current-title">接诊记录</h3>
      
      <!-- 删除此行注释，在此添加对应的div -->
     <div class="search-content">
       <form id="entity" action="incompleteRecordAction2!searchIncompleteRecord.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="incompleteRecordAction2!findAndAddIncompleteRecord.action" class="btn">添加</a>
     </div>
 	</form>
     </div>
  ...
  <form action="incompleteRecordAction!fuction.action" method="post">
   <table class="table table-bordered">
     <thead>
      ...
      <tbody>
     <%--   <s:action name="incompleteRecordAction!showIncompleteRecord.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vincompleteRecordList" status="n" var="v">
        <input type="hidden" name="choice" value="${incompleteRecordId}">
       <tr>
        <%--  <td><input class="zyq" type="checkbox" name="allIncompleteRecordId" id="ck_id" value="${incompleteRecordId}"></td> --%>
         
         <td><c:out value="${v.name}"></c:out></td>
         <td>
         <c:if test="${v.sex==false}">男</c:if>
         <c:if test="${v.sex==true}">女</c:if>
         </td>
         <td><c:out value="${v.age}"></c:out></td>
         <td><c:out value="${v.fileNum}"></c:out></td>
         <td><c:out value="${v.incompleteRecordDate}"></c:out></td>
         <td colspan="3"><a class="btn-xinzeng" href="incompleteRecordAction2!turnToAddPersonIncompleteRecord.action?healthFileId=${healthFileId}&hid=${healthFileId}">新增</a>
         <a class="btn-xianshi" href="incompleteRecordAction2!turnToDetailIncompleteRecord.action?healthFileId=${healthFileId}&irId=${incompleteRecordId}">详情</a>
        <%-- <a class="btn-xianshi" href="incompleteRecordAction2!turnToDetailIncompleteRecord.action?healthFileId=${healthFileId}&irId=${incompleteRecordId}">详情</a> --%>
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="incompleteRecordAction2!deleteIncompleteRecord.action?irId=${incompleteRecordId}">删除</a>
         <a class="btn-xiugai" href="incompleteRecordAction2!turnToUpdateIncompleteRecord.action?irId=${incompleteRecordId}&healthFileId=${healthFileId}">修改</a></td>
       </tr>
       </s:iterator>
     </tbody>
   </table>
