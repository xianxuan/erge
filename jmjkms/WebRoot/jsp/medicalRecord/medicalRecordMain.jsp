...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
        <h3 class="current-title">长期用药记录</h3>
      
      <!-- 删除此行注释，在此添加对应的div -->
     <div class="search-content">
     <input name="yemianname" value="06205" type="hidden"/>
     <form id="entity" action="medicalRecordAction!searchMedicalRecord.action" method="post">
    ...
    <%--  <div class="search-item">
     ...
     <div class="btn-content">
       ...
       <a class="btn-xinzeng btn" href="medicalRecordAction!findAndAddMedicalRecord.action" class="btn">添加</a>
     </div>
 	</form>
     </div>
  <div class="table-content">
    <form action="medicalRecordAction!fuction.action" method="post">
   <table class="table table-bordered">
     <tbody>
       <tr>
        ...
        <%-- <s:action name="medicalRecordAction!showMedicalRecord.action" namespace="/" var="home1"></s:action> --%>
       <s:iterator value="vmedicalRecordList" status="n">
       <input type="hidden" name="choice" value="${medicalRecordId}">
       <tr>
		<%--  <td><input class="zyq" type="checkbox" name="allMedicalRecordId" id="ck_id" value="${medicalRecordId}"></td> --%>
         ...
         <td><c:out value="${drugName}"></c:out></td>
        <td colspan="3"><a class="btn-xinzeng" href="medicalRecordAction!turnToAddPersonMedicalRecord.action?healthFileId=${healthFileId}">新增</a>
         <a class="btn-xianshi" href="medicalRecordAction!turnToDetailMedicalRecord.action?healthFileId=${healthFileId}&mrId=${medicalRecordId}">详情</a>
         <a onclick="return confirm('是否删除？');" class="btn-shanchu" href="medicalRecordAction!deleteMedicalRecord.action?mrId=${medicalRecordId}">删除</a>
         <a class="btn-xiugai" href="medicalRecordAction!turnToUpdateMedicalRecord.action?mrId=${medicalRecordId}&healthFileId=${healthFileId}">修改</a></td>
       </tr>
       </s:iterator>
