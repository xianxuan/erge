  ...
  <div class="main-content clearfix">
    ...
    <div class="container">
     ...
     <s:if test="issq==1"><!-- 0是平台管理员登陆，1是集团登陆，2是其他登陆 -->
       ...
       <label>年龄：</label>
       <input  id="input1" maxlength="4" name="searchbean.lowAge"   type="text" class="w40"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">至<input  id="input2" maxlength="4" name="searchbean.highAge"   type="text" class="w40"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">岁
     </div>
     <%-- <div class="search-item">
       <label>出生日期：</label>
