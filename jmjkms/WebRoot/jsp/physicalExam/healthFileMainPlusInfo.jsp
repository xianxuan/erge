            ...
            <tr>
             ...
             <%--  <td><input class="zyq qq" type="checkbox" name="allHealthFileId" id="ck_id" value="${healthFileId}"></td> --%>
              ...
              <td>
				...
				<a href="PhysicalExamAction!showPhysicalExamListBypersonal.action?healthFileId=${healthFileId}&belongSystem=${belongSystem}&fileNum=${fileNum}&jiGouFileNum=${fileNum}&jiGouname=${name}&jiGousex=${sex}"  class="btn-xianshi">查看体检</a>
