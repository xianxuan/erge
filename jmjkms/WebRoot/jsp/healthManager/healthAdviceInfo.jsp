...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">健康建议详情</h3>
 <!-- 表单表格 start -->
         ...
         <div class="table-content">
             ...
             <table class="table table-bordered table_change" id="jqprint">
                       <tbody>
                       		<tr>
                                      <td>姓名</td>
                                      <td colspan="6"><c:out value="${userName}"></c:out></td>
                           </tr>
                           <tr>
                                      <td>责任医生</td>
                                      <td colspan="6"><c:out value="${doctorName}"></c:out></td>
                           </tr>
                           <tr>
                                      <td>现存主要健康问题</td>
                                      <td colspan="6"><c:out value="${wenti}"></c:out></td>
                           </tr>
                           <tr>      
                           			  <td>指导意见</td>
                                      <td colspan="6"><c:out value="${doctorAdvice}"></c:out></td>
