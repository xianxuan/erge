      ...
      <h3 class="current-title">血氧档案-趋势分析</h3>
       ...
       <div class="search-content">
          <div class="btn-content">
            ...
            <a href="HealthManagerAction!getBloodOxygenFromCloud.action?bloodForward=1&healthFileId=${localHealthFile.healthFileId}" class="btn ">趋势分析</a>
...
function myHighchars(){
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: '${localHealthFile.name}的血氧趋势图'
        },
        xAxis: {
              categories: ${xAxis},
        },
