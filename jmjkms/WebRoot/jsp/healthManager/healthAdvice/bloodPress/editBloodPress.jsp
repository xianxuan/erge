           ...
           <table class="table table-bordered">
             <tbody>
               <tr>
                 ...
                 <td>药物名称</td>
                 <td>
                 	  <input type="text" class="w150" id="medName"   maxlength='20' name="bloodPress.medName" value = "${medName }"/>
                 </td>
               </tr>
                <tr>
                <td><span style="color:red">*</span>测量手臂</td>
                 ...
                 <td><input type="text"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength='10' name="bloodPress.pulse" datatype="*" nullmsg="脉率不可为空"  value="${pulse }"></td>
                 <td><span style="color:red">*</span>收缩压(mmHg)</td>
                <td><input type="text" onkeyup="Num(this)" maxlength='10' name="bloodPress.sysPre"  datatype="*" nullmsg="收缩压不可为空"  value="${sysPre}"></td>
                 <td><span style="color:red">*</span>舒张压(mmHg)</td>
                 <td> <input type="text" onkeyup="Num(this)" maxlength='10' name="bloodPress.diaPre"  datatype="*" nullmsg="舒张压不可为空" value="${diaPre }"></td>
               </tr>
               <tr>                 
           </tr>
             </tbody>
