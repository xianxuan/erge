  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
     <div class="container">
      ...
      <input name="yemianname" value="02202" type="hidden"/>
       <div class="search-content">
          <div class="btn-content">
            <a href="HealthManagerAction!getBloodPressFromCloud.action?bloodForward=0&healthFileId=${healthFile.id }" class="btn">数据分析</a>
      ...
      <form action="HealthManagerAction!bloodPressDataAnalysis.action" method="post" >
