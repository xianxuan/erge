      ...
      <input name="yemianname" value="02202" type="hidden"/>
       <div class="search-content">
         ...
         <a href="HealthManagerAction!getBloodPressFromCloud.action?bloodForward=0&healthFileId=${healthFile.id }" class="btn btn-default">数据分析</a>
            <a href="HealthManagerAction!getBloodPressFromCloud.action?bloodForward=1&healthFileId=${healthFile.id }" class="btn">趋势分析</a>
            <a href="HealthManagerAction!getBloodPressFromCloud.action?bloodForward=2&healthFileId=${healthFile.id }" class="btn btn-default">详细数据</a>
       ...
       <form id="registerform" action="HealthManagerAction!bloodPressTendAnalysis.action" method="post">
