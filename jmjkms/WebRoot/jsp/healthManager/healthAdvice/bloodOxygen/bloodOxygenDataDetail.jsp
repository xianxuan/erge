      ...
      <h3 class="current-title">血氧档案-详细数据</h3>
       ...
       <div class="search-content">
          <div class="btn-content">
            ...
            <a href="HealthManagerAction!getBloodOxygenFromCloud.action?bloodForward=1&healthFileId=${healthFile.id }" class="btn btn-default">趋势分析</a>
            <a href="HealthManagerAction!getBloodOxygenFromCloud.action?bloodForward=2&healthFileId=${healthFile.id }" class="btn ">详细数据</a>
          </div>
      </div>
       ...
       <table class="table table-bordered">
         ...
         <s:iterator value="bloodOxygenList" var="bol"> 
           <tr>
             ...
             <td class="caozuo">
               <a class="btn-xiugai" href="HealthManagerAction!toEditBOCloud.action?bloodOxygen.meaTime=${bol.meaTime}&healthFileId=${healthFile.id }&bloodOxygen.id=${bol.id}&bloodOxygen.meaState=${bol.meaState}&bloodOxygen.oxygen=${bol.oxygen}&bloodOxygen.pulse=${bol.pulse}&bloodOxygen.takeMed=${bol.takeMed}&bloodOxygen.medName=${bol.medName}&bloodOxygen.abnAlarm=${bol.abnAlarm}&bloodOxygen.analysisResult=${bol.analysisResult}">修改</a>
               <a class="btn-shanchu" href="HealthManagerAction!deleteBloodOxygenDataCloud.action?cloudId=${bol.id}&healthFileId=${healthFile.id }" onclick="return confirm('确认删除')">删除</a>
              </td> 
           </tr>
         </s:iterator> 
         </tbody>
