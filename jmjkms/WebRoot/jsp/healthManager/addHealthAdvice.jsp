...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
    <h3 class="current-title">健康建议添加</h3>
 <!-- 表单表格 start -->
                 
    <div class="table-content">
        <input name="yemianname" value="02202" type="hidden"/>
          <form id="registerform" action="HealthManagerAction!addSuggestByHealthFileId.action" method="post" onsubmit="return dosubmit()">
             ...
             <table class="table table-bordered">
                       <tbody>
                            <tr>
                                <td>现存主要健康问题</td>
                                <td>
                                    <input type="text" class="temp" name="wenti" datatype="*" nullmsg="现在健康问题不可为空" />
                                </td>
                            </tr>
                           <tr>
                                      <td>指导意见</td>
                                      <td colspan="6">
                                        <textarea   name="doctorAdvice" datatype="*" nullmsg="指导意见不可为空" class="textarea temp"></textarea>   
                                      </td>
                           </tr>
                           <tr>
                                      <td><span class="required">*</span>日期</td>
                                      <td colspan="6"><input type="text" name="createTime" value="${currentTime }" class="w150" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"></td>
                           </tr>
