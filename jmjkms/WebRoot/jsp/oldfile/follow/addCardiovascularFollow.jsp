...
<head><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge">
  ...
  <link rel="stylesheet" href="/jmjkms/css/main.css"><link rel="stylesheet" href="/jmjkms/css/font-awesome-4.5.0/css/font-awesome.min.css">
...
<body>
  ...
  <input name="yemianname" value="01202" type="hidden"/>
    ...
    <div class="container">
      ...
      <form action="<%=basePath %>oldChronicFollowAction!addCarddiovascular.action?cid=${chronicDisease.chronicDiseaseId}&hid=${healthFile.healthFileId}" onsubmit="return dosubmit()"  method="post" id="registerform">
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
               ...
               <input onkeyup="Num(this)" type="text" name="followcardheart.diastolicBlood" maxlength="10" >
             </td>
             <td>收缩压（mmHg）</td>
             <td>
               <input onkeyup="Num(this)" type="text" name="followcardheart.systolicBlood" maxlength="10" >
             </td>
             <td>心率（次/分）</td>
             <td>
               <input onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" type="text" name="followcardheart.heartRate" maxlength="10" >
             </td>
             <td>体重（kg）</td>
             <td>
               <input onkeyup="Num(this)" type="text" name="followcardheart.weight" maxlength="10" >
             </td>
            </tr>
            <tr>
	              <td>是否有心律失常</td>
	              ...
	              <td>
	               ...
	               <td>平均测血压间隔时间（天）</td>
	              <td>
	               <input onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" type="text" name="followcardheart.meanTimeMeasureBloodPressure" maxlength="10" >
	              </td>
	              <td>是否用药</td>
	              <td>
              ...
              <table class="table table-bordered">
             	...
             	<tr>
	              ...
	              <td>
	               ...
	               <td>下次随访预约时间</td>
	               <td colspan="3">
	               		<input type="text" class="w150" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" onfocus="this.blur()" name="followcardheart.nextAppointmentDate">
	               </td>
            </tr>
             <tr>
              	<td>随访指导意见</td>
                <td colspan="7">
               		<textarea   name="followcardheart.appointmentIdea" id=""  class="textarea temp"></textarea>
               </td>
             </tr>
             <tr>
               <td>备注</td>
               <td colspan="7">
               		<textarea   name="followcardheart.tip" id=""  class="textarea temp"></textarea>
               </td>
             </tr>
             <tr>
              <td colspan="8" class="title-td"></td>
             ...
             <tr>
               ...
               <td><input   type="text" name="followcardheart.fllowedUp" maxlength="10" datatype="*" nullmsg="被随访人不可为空"></input></td> --%>
...
<script type="text/javascript">
		...
		function dosubmit() {
			...
			if (isCommitted == false
					&& document.getElementById('sfys').value != ""&& document.getElementById('time').value != "") {
