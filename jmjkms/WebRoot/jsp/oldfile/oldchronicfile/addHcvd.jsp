    ...
    <div class="container">
      ...
      <div class="search-content">
        ...
        <%-- <div class="btn-content">
            ...
            <a href="<%=basePath %>showOldChronicAction!jumpHcvd.action?helid=${healthFile.healthFileId}" class="btn">心脑血管病</a>
            <a href="<%=basePath %>showOldChronicAction!jumpDisability.action?helid=${healthFile.healthFileId}" class="btn btn-default">残疾、障碍</a>
          </div> --%>
      </div>
      <!-- 结果容器 start -->
      <h3 class="current-title">新建心脑血管病档案</h3>
      <form action="<%=basePath %>showOldChronicAction!addHcvd.action" onsubmit="return dosubmit()" method="post" id="registerform">
      <div class="table-content">
        <table class="table table-bordered">
          <tbody>
           ...
           <tr>
             <td colspan="2">心脑血管病类型<input type = "hidden" name = "chronicDisease.diseaseName"  value= "心脑血管病" ><input type="hidden" value="${chid}" name="chid"></td>
             <td colspan="6" >
           ...
           <tr>
             ...
             <td colspan="8">
             	 首诊信息：  <textarea  
             	  name="hcvd.fristDiagnose" id=""  class="textarea temp" ></textarea>
             </td>
        ...
        <tr>
          ...
          <tr>
            ...
            <td  colspan="8" >
            	  备注：<textarea  
            	   name="hcvd.remarks" id=""  class="textarea temp"></textarea>
            </td>
          </tr>
           ...
           <tr>
             ...
             <%-- <td >
            	 <span class="required">*</span>被调查人
             </td>
              <td >
              <input  
               type="text" name="hcvd.investigatedPerson" maxlength="10" datatype="*" nullmsg="被调查人不可为空">
             </td> --%>
              <td >
         		   <span class="required">*</span> 建档人
             </td>
              <td >
