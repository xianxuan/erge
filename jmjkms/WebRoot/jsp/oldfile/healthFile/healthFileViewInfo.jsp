				...
				<form action="healthFileAction!updateHealthFile.action"
					...
					<table class="table table-bordered" id="jqprint"
						...
						<tbody>
							...
							<tr>
								<td>责任医生</td>
								 <td><c:out value="${doctorName}"></c:out></td> 
								 <td>建档日期</td>
								 <td><c:out value="${healthFileCloudSingle.createtime}"></c:out></td>
							 </tr>
							<tr>
								<td>乡镇（街道）名称</td>
							...
							<tr>
								<td>常驻类型</td>
								<c:if test="${healthFileCloudSingle.permanentType==0}"> <td><c:out value="户籍"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.permanentType==1}"> <td><c:out value="非户籍"></c:out></td></c:if>
							...
							<tr>
								<td>血型</td>
								<c:if test="${healthFileCloudSingle.bloodTypr==0}"> <td><c:out value="A型"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.bloodTypr==1}"> <td><c:out value="B型"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.bloodTypr==2}"> <td><c:out value="o型"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.bloodTypr==3}"> <td><c:out value="AB型"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.bloodTypr==4}"> <td><c:out value="不详"></c:out></td></c:if>
								<!-- <td><c:out value="${healthFileCloudSingle.bloodTypr}"></c:out></td> -->
								<td>RH阴性</td>
								<c:if test="${healthFileCloudSingle.rhNegative==0}"> <td><c:out value="否"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.rhNegative==1}"> <td><c:out value="是"></c:out></td></c:if>
								  <c:if test="${healthFileCloudSingle.rhNegative==2}"> <td><c:out value="不详"></c:out></td></c:if>
							...
							<tr>
								<td>身高</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.height eq 0.0}"><td>cm</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.height}cm"></c:out></td></c:otherwise>  
                                </c:choose>
								<td>体重</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.weihth eq 0.0}"><td>kg</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.weihth}kg"></c:out></td></c:otherwise>  
                                </c:choose>
							</tr>
							<tr>
								<td>腰围</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.waistline eq 0.0}"><td>cm</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.waistline}cm"></c:out></td></c:otherwise>  
                                </c:choose>
								<td>臀围</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.hipline eq 0.0}"><td>cm</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.hipline}cm"></c:out></td></c:otherwise>  
                                </c:choose>
							</tr>
							<tr>
								<td>收缩压</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.systolicBloodPressure eq 0.0}"><td>mmgh</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.systolicBloodPressure}mmgh"></c:out></td></c:otherwise>  
                                </c:choose>
								</td>
								<td>舒张压</td>
								<c:choose>
                                       	<c:when test="${healthFileCloudSingle.diastolicBloodPressure eq 0}"><td>mmgh</td></c:when>
                                       	<c:otherwise> <td><c:out value="${healthFileCloudSingle.diastolicBloodPressure}mmgh"></c:out></td></c:otherwise>  
                                </c:choose>
							</tr>
							<tr>
								<td>老人卡NFC编码</td>
...
<tr>
                                   ...
                                   <tr>
                                       ...
                                       <c:choose>
                                       	<c:when test="${lifestyle.smokingOneday eq 0.0}"><td>两 </td></c:when>
                                       	<c:otherwise> <td>${lifestyle.smokingOneday}两 </td></c:otherwise>  
                                       </c:choose>
                                       <td>开始吸烟年龄</td>
                                       <c:choose>
                                       	<c:when test="${lifestyle.startsmokingAge eq 0}"><td>岁</td></c:when>
                                       	<c:otherwise> <td>${lifestyle.startsmokingAge}岁</td></c:otherwise>  
                                       </c:choose>
                                   </tr>
                                   <tr>
                                       <td>戒烟年龄</td>
                                       <c:choose>
                                       	<c:when test="${lifestyle.giveupSmokingAge eq 0}"><td>岁</td></c:when>
                                       	<c:otherwise> <td>${lifestyle.giveupSmokingAge}岁</td></c:otherwise>  
                                       </c:choose>
                                   ...
                                   <tr>
                                       <td>日饮酒量</td>
                                       <c:choose>
                                       	<c:when test="${lifestyle.monthlyDrinking eq 0.0}"><td>两</td></c:when>
                                       	<c:otherwise> <td>${lifestyle.monthlyDrinking}两</td></c:otherwise>  
                                       </c:choose>
                                   ...
                                   <tr>
                                     <td>开始饮酒年龄</td>
                                      <c:choose>
                                       	<c:when test="${lifestyle.startDrinkingAge eq 0}"><td>岁</td></c:when>
                                       	<c:otherwise> <td>${lifestyle.startDrinkingAge}岁</td></c:otherwise>  
                                       </c:choose>
                                        <td>近一年内是否曾醉酒</td>
                                       <td colspan="1">
							...
							<tr>
								...
								<c:if test="${belongSystemQianDuan=='1'}">
							...
							<tr>
								...
								<c:if test="${belongSystemQianDuan=='1'}">
					              	<c:out value="${healthFileCloudSingle.two}"></c:out>
					              </c:if>
									</td>
							</tr>
							<tr>
								...
								<c:if test="${belongSystemQianDuan=='1'}">
					              	<c:out value="${healthFileCloudSingle.three}"></c:out>
					              </c:if>
									</td>
							</tr>
							<tr>
								...
								<c:if test="${belongSystemQianDuan=='1'}">
					              	<c:out value="${healthFileCloudSingle.four}"></c:out>
					              </c:if>
									</td>
							</tr>
							<tr>
								<td>遗传病史</td>
								<td><c:out value="${healthFileCloudSingle.geneticHistory}"></c:out></td>
