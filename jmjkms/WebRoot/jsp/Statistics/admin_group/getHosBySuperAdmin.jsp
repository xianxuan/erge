...
<body>
	...
	<div class="main-content clearfix">
		...
		<div class="container">
			...
			<h3 class="current-title">社区集团统计分析</h3>
			<div class="search-content">
				<form
					action="<%=basePath %>statisticsAction!getStatisticsListBySuperAdmin.action"
					method="post">
					<div class="search-item">
						<label>请选择社区集团：</label>
						<div id="add">
							<input id="laoren" type="checkbox"
								onclick="return checkAll(this)"><label for="laoren">全选</label>
						</div>
					</div>
			...
			<!-- 结果容器 start -->
			<h3 class="current-title">社区集团统计分析查询结果</h3>
			<div class="table-content">

				<table class="table table-bordered">
					<tbody>
						<tr>
							<td colspan="8" class="title-td">所选集团： <s:iterator
									value="selectGroups" var="list">
             ${list.groupName},
             </s:iterator>
							</td>
						...
						<tr>
							<td>总人数：</td>
							<td>${communityHospitalCount[0]}<s:if
									test="communityHospitalCount[0]!=null">
									<lable>人</lable>
								</s:if>
							</td>
						</tr>
						<tr>
							<td>老年人口数（55岁以上）：</td>
							<td>${communityHospitalCount[1]}<s:if
									test="communityHospitalCount[1]!=null">
									<lable>人</lable>
								</s:if>
							</td>
						</tr>
						<tr>
							<td>患病老人数：</td>
							<td>${communityHospitalCount[2]}<s:if
									test="communityHospitalCount[2]!=null">
									<lable>人</lable>
								</s:if>
							</td>
						</tr>
				...
				<div class="btn-content">
					<form
						action="<%=basePath %>statisticsAction!jumpCurrentCount.action"
						method="post">
						<div class="search-item">
							<s:iterator value="selectGroups" var="ch">
								<input id="sq_1" type="hidden" name="groupIdList"
									value="${ch.GId}" />
								<label for="sq_1"></label>
							</s:iterator>
						</div>
						<div class="btn-content">
							<input type="submit" value="统计各类疾病人数比例曲线"
								class="btn btn-xianshi ">
