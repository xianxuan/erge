...
<body>
    ...
    <div class="main-content clearfix">
        ...
        <div class="container">
            ...
            <input name="yemianname" value="08203" type="hidden"/>
                ...
                <form
                    action="<%=basePath%>statisticsAction!getComHosDiseaseAnalyseByAD.action"
                    method="post">
                    <div class="search-content">
                        <td colspan="8" class="title-td">所选集团：
                        <label id="box">
	                         <s:iterator value="selectGroups" var="list">
	                                <input id="sq_1" type="hidden" name="groupIdList11"
	                                    value="${list.GId}" />
    ...
    <script> 
        $(function show(){ 
            ...
            newBox.innerHTML = text.substring(0,4000); //截取字符串200
            btn.innerHTML = text.length > 4000 ? "...显示全部" : ""; 
            //btn.href = "###"; 
            ...
            btn.onclick = function(){ 
                ...
                if (btn.innerHTML == "...显示全部"){ 
                        ...
                        btn.innerHTML = "...显示全部"; 
                        newBox.innerHTML = text.substring(0,4000); 
                } 
            } 
                box.innerHTML = ""; 
