	...
	<div class="main-content clearfix">
		...
		<div class="container">
			...
			<input name="yemianname" value="08203" type="hidden"/>
				...
				<form
					action="<%=basePath%>statisticsAction!getAllComHosDiseaseAnalyse.action"
					method="post">

					<div class="search-content">
						<td colspan="8" class="title-td">医院： 
						<label id="box">
							<s:iterator
									value="selectHospitals" var="list">
   ...
   <script src="/jmjkms/js/jquery.jqprint-0.3.js"></script>
    ...
    <script> 
        $(function show(){ 
            ...
            newBox.innerHTML = text.substring(0,3000); //截取字符串200
            btn.innerHTML = text.length > 3000 ? "...显示全部" : ""; 
            ...
            btn.onclick = function(){ 
                ...
                if (btn.innerHTML == "...显示全部"){ 
                	    ...
                	    btn.innerHTML = "...显示全部"; 
                        newBox.innerHTML = text.substring(0,3000); 
                } 
            } 
                box.innerHTML = ""; 
