...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">康复计划详情页</h3>
   ...
   <input name="yemianname" value="04202" type="hidden"/>
        <table class="table table-bordered" id="jqprint">
          <tbody>
           <tr>
                <td>计划名称</td>
                <td colspan="2"><c:out value="${plan.planName }"></c:out></td>
         </tr>
        <tr>
       <td><label>方案类型</label></td>
       <td><c:out value="${plan.TRecoveryScheme.type }"></c:out></td>
     </tr>
      <tr>
          <td>
 			 <label>方案名称</label>
                      </td>
                      <td><c:out value="${plan.TRecoveryScheme.schemeName }"></c:out> </td>
    </tr>
     <tr>
             <td>
                    <label>老人</label>
                       ...
                       <td>
                          <s:iterator value="oldList" var="list">
                          <label> <c:out value="${list.THealthFile.name }"></c:out> </label>
                            </s:iterator>
                              </td>
                               </tr>
     <tr>
             <td>
                    <label>开始日期：</label>
                       ...
                       <td>
                       <fmt:formatDate value="${plan.beginTime }" pattern="yyyy-MM-dd" />
                              </td>
                               </tr>
     <tr>              <td>
                              <label>结束日期：</label>
                        ...
                        <td>
                        <fmt:formatDate value="${plan.overTime }" pattern="yyyy-MM-dd" />
                            </td>
        </tr>
   ...
   <div class="btn-content">
     <a href="healthPhysiotherapyAction!getAllPlan.action" class="btn">返回</a>
