...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
      <h3 class="current-title">糖尿病医生诊断编辑</h3>
 <!-- 表单表格 start -->
                         ...
                         <tr>
                           ...
                           <tr>       <td>建议</td>
                            ...
                            <tr>
                                      ...
                                      <td colspan="6"><input type="text" id="time" name="date" value="<fmt:formatDate value='${doctorDiagnosis.date}' pattern='yyyy-MM-dd'/>" class="w150" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"></td>
                           </tr>
                       </tbody>
               </table>
