...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
          <h3 class="current-title">糖尿病医生诊断</h3>
...
<!-- 搜索容器 start -->
  ...
  <input name="yemianname" value="02205" type="hidden"/>
    <form action="doctorDiagnosisAction!searchDoctorDiagnosis.action" method="post">
        ...
        <a class="btn btn-xinzeng" href="doctorDiagnosisAction!addDoctorDiagnosis.action?daId=${daId}&chronicName=${chronicName}">添加诊断</a>
    </form>
