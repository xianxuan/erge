...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <input name="yemianname" value="10204" type="hidden"/>
		<h3 class="current-title">增加角色</h3>
		<!-- 删除此行注释，在此添加对应的div -->
        <div class="main_juese">
       	<div class="title_juese">
       		<label>角色名称:</label><input class="temp"  type="text" name="roleName">
		...
		<div class="btn-content">
			...
			<a href="javascript:;" class="btn btn_return" style="margin-right: 10px;" onclick="return subForm();">确定</a>
		</div>
	</div>
