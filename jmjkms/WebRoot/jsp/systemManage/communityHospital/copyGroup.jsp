...
<body>
  ...
  <div class="main-content clearfix">
    ...
    <!-- 主容器 start -->
    <div class="container">
		<h3 class="current-title">复制集团账号</h3>
      
		<!-- 删除此行注释，在此添加对应的div -->
		<div class="table-content">
		<input name="yemianname" value="10201" type="hidden"/>
			<form id="registerform" onsubmit="return dosubmit()" class="check-form" action="<%=basePath %>communityHospitalAction!copyGroup.action" method="post">
        		...
        		<table class="addHospital">
         			<tbody>
                        <tr>
                            ...
                            <td>
                                <input class="temp"  id="host" type="text" name="groupHostName" maxlength="10" nullmsg="不可为空" datatype="*"></input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="loginin" placeholder="填写6-18位字母 数字 下划线组合" style="font-size:10px; width:149px; height:20px;" onkeyup="value=value.replace(/[^\w]/ig,'')" type="text" maxlength="18" name="groupLoginname" nullmsg="不可为空" errormsg="请填写6到18位数字、字母或下划线" datatype="*6-18"></input>
                            </td>
                            <td>
                                <label style="color:red;">初始密码和账号一致</label>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="phone" type="text" onkeyup="value=value.replace(/[^\w]/ig,'')" name="groupPhone" maxlength="15"  nullmsg="不可为空" datatype="*"></input>
                            </td>
                            <td>
                    ...
                    <table class="table">
                        <tr>
                            <td>说明</td>
                            <td>
                                <textarea name="groupNote" id=""  class="textarea"></textarea>
                            </td>
                        </tr>
          			</tbody>
       			</table>
...
function loginname(){
	var login =$("input[name='groupLoginname']").val();
...
$(function (){
	loginname();
	$("input[name='groupLoginname']").blur(function(){document.getElementById("btnsubmit").disabled=false;loginname();} );
	$("input[name='groupPhone']").blur(function(){document.getElementById("btnsubmit").disabled=false;checkTel();});
});
